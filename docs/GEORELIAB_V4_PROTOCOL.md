...
> Supporting protocol reference only. The v2.2 Taskbook is the sole execution entry; this file cannot authorize a run and is not changed by the current docs-only mainline update.
